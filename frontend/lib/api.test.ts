...
assertEqual(resolvePosterUrl(cdnUrl, 'https://fallback.example.com/remote.jpg'), `${cdnUrl}?format=webp`, 'cdn absolute url');
assertEqual(
...
assertEqual(
  ...
  `${PUBLIC_API_BASE}/posters/local.jpg?format=webp`,
  'local poster path with webp',
);
